...
def split_text(text, max_length=MAX_CHARS):
    """Розбиває текст на окремі слова, видаляючи переноси рядків."""
    # Замінюємо всі переноси рядків на пробіли і розбиваємо на слова
    words = text.replace("\n", " ").split()
    # Повертаємо список слів, кожне як окремий елемент
